...
public class Test {
	...
	public void extentSetup() {
		...
		reports.setSystemInfo("Machine", "Nuru");
		reports.setSystemInfo("Env", "Jenkins");
	...
	public void passTest(){
	    ...
	    test.pass("Method Passed");
	}
	@org.testng.annotations.Test
	public void passFailed(){
		test = reports.createTest("Second");
		System.out.println("This is our Failed test");
	...
	@org.testng.annotations.Test
	public void passPassed(){
		test = reports.createTest("Third");
		System.out.println("This is our Passed test");
